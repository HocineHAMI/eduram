...
En effet chaque joueur possède un rôle qui lui permet de faire des actions différente des autres joueurs ( exemple : le scientifique peut créer un vaccin pour seulement 4 cartes ).
Le jeu est perdu si il y a eu plus de 8 éclosions, si il n'y a plus de cartes dans la pioche des joueurs, ou si on ne peux plus placer de cubes de virus sur la carte. La partie est gagné lorsque tous les vaccins ont été créés.
...
Cette amélioration aurait été très amusante à mettre en place, mais elle aurait complètement bouleversé le gameplay et nous aurions du revoir une grande partie de l'implémentions.
